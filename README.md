...
- [techtown-fr/slidev-theme](https://github.com/techtown-fr/slidev-theme) - 🎨 TechTown Slidev Theme (3 weeks ago)
...
- [fix(bedrock): fix on-demand throughput doc URL to preserve anchor fragment](https://github.com/strands-agents/sdk-python/pull/2228) on [strands-agents/sdk-python](https://github.com/strands-agents/sdk-python) (1 week ago)
- [chore(): add Dependabot configuration](https://github.com/bengeois/aws-layer-duckdb-python/pull/15) on [bengeois/aws-layer-duckdb-python](https://github.com/bengeois/aws-layer-duckdb-python) (3 weeks ago)
- [fix: resolve theme assets via Vite imports instead of absolute paths](https://github.com/techtown-fr/slidev-theme/pull/2) on [techtown-fr/slidev-theme](https://github.com/techtown-fr/slidev-theme) (3 weeks ago)
...
- [ksimback/tech-debt-skill](https://github.com/ksimback/tech-debt-skill) - Claude Code skill that produces a thorough, file-cited tech debt audit of an entire codebase (6 days ago)
...
- [google/skills](https://github.com/google/skills) - Agent Skills for Google products and technologies (1 week ago)
- [romainsimon/paperasse](https://github.com/romainsimon/paperasse) - 🇫🇷  Skills pour agents IA spécialisés dans la bureaucratie française : Comptable, Notaire, ... (3 weeks ago)
